...
#### During experimentation with my text classification model, I conducted tests comparing its performance with and without the inclusion of a dropout layer.The loss of both train and test data will increases and accuracy of train and test data will decreases
